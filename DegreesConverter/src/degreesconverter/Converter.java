...
public class Converter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtCelcius.setName("txtCelcius"); // NOI18N
        txtCelcius.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtCelciusKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtCelciusKeyReleased(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtCelcius, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void btnConvertMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConvertMouseClicked
        double celsius = Double.parseDouble(this.txtCelcius.getText());
        int result = (int)(celsius * 1.8 + 32); 
        lblResult.setText(result + " Fahrenheit"); 

        
    }//GEN-LAST:event_btnConvertMouseClicked

    private void txtCelciusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCelciusKeyPressed
      
    }//GEN-LAST:event_txtCelciusKeyPressed

    private void txtCelciusKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCelciusKeyReleased
          String sText = txtCelcius.getText();
        if(!sText.matches("^[0-9]*$")){
           txtCelcius.setText("");
        }
    }//GEN-LAST:event_txtCelciusKeyReleased
